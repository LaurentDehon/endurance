...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/calendar/{year?}', function() { return view('calendar-wrapper'); })->middleware(['strava.token'])->name('calendar');  
    Route::get('/activities', function() { return view('activities-wrapper'); })->name('activities');
