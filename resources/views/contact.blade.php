...
<div class="contact-container mx-auto p-4 md:p-8 max-w-7xl min-h-[calc(100vh-var(--nav-height)-var(--footer-height,0px))]">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="md:col-span-2">
            <div class="section-card bg-white bg-opacity-10 border-white border-opacity-20 shadow-sm backdrop-blur-lg rounded-xl p-6 md:p-8 shadow-lg border">
        ...
        <div class="md:col-span-1">
            <div class="section-card bg-white bg-opacity-10 border-white border-opacity-20 shadow-sm backdrop-blur-lg rounded-xl p-6 md:p-8 shadow-lg border mb-6">
                <div class="flex items-center gap-4 mb-6">
                    <div class="w-12 h-12 rounded-full text-white bg-cyan-600 hover:bg-cyan-500 flex items-center justify-center">
    ...
    <!-- FAQ Section -->
    <div class="section-card bg-white bg-opacity-10 border-white border-opacity-20 shadow-sm backdrop-blur-lg rounded-xl p-6 md:p-8 shadow-lg border mt-8">
        <div class="flex items-center gap-4 mb-6">
            <div class="w-12 h-12 rounded-full text-white bg-cyan-600 hover:bg-cyan-500 flex items-center justify-center">
