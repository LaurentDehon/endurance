    ...
    'themes' => [
        'blue' => [
            ...
            'colors' => [
                ...
                'card' => ['bg-white', 'bg-opacity-10', 'border-white', 'border-opacity-20', 'shadow-sm'],
                'week' => ['bg-white', 'bg-opacity-10', 'border-white', 'border-opacity-20'],
                'text-1' => ['text-white'],
                'text-2' => ['text-cyan-200'],
                'text-3' => ['text-slate-300'],
                'text-link' => ['text-cyan-400'],
                'text-accent'=> ['text-amber-300'],
                'select'=> ['hover:bg-white', 'hover:bg-opacity-20'],
                ...
                'toast-success' => ['bg-green-100', 'text-green-800', 'shadow-green-200', 'shadow-opacity-20'],
                'toast-error' => ['bg-red-100', 'text-red-800', 'shadow-red-200', 'shadow-opacity-20'],
                'toast-warning' => ['bg-yellow-100', 'text-yellow-800', 'shadow-yellow-200', 'shadow-opacity-20'],
                'toast-info' => ['bg-blue-100', 'text-blue-800', 'shadow-blue-200', 'shadow-opacity-20'],
